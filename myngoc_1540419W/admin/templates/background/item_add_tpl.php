<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=background&act=man&typechild=<?=$_GET['typechild']?>" ><span><?=$name_cap?></span></a></li>
...
<form name="frm" method="post" action="index.php?com=background&act=save&typechild=<?=$_GET['typechild']?>" enctype="multipart/form-data" class="nhaplieu">		
    ...
    <div class="widget">
        ...
        <div class="formRight">
         ...
         <?php
		 	if($item['photo']!=''){
		?>
        <b>&nbsp;</b><img src="<?=_upload_background.$item['photo']?>" width="150" height="150" /><br /><br>
        ...
        <?php
		 ...
		 ?>
          ...
          <input type="file" name="file" />&nbsp;<?=$kichthuoc_image?> jpg|png|gif
       ...
       <div class="formRow">
        ...
        <div class="formRow">
			...
			<input type="submit" value="Lưu" class="btn blueB" />
			</div>
			<div class="clear"></div>
		</div>
