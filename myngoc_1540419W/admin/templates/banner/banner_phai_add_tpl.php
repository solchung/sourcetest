<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=banner&act=man_phai"><span>Cập nhật Logo</span></a></li>
...
<form name="frm" method="post" action="index.php?com=banner&act=save_banner_phai" enctype="multipart/form-data" class="nhaplieu">
  ...
  ?>
   ...
   ?>
    		...
    		<img src="<?= _upload_hinhanh . $item['banner_'.$value]?>" alt="" >
   ...
   ?><br /><br />
      ...
      <div class="formRight">
        <input type="file" name="file_<?=$value?>" /> <strong>Width:auto&nbsp;-&nbsp;Height:auto&nbsp;  
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=banner&act=man_phai'" class="blueB" />
			</div>
			<div class="clear"></div>
		</div>
