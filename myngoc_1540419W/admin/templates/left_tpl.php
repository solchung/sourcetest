...
<ul id="menu" class="nav">
    ...
    <li class="article_li<?php if ( $_GET['com'] == 'news' && ( $_GET['typechild'] == 'khachhang' || $_GET['typechild'] == 'tailieu'|| $_GET['typechild'] == 'chinhsach'|| $_GET['typechild'] == 'news' || $_GET['typechild'] == 'dichvu')) echo ' activemenu' ?>" id="menu_baiviet"><a href="#" title="" class="exp"><span>Danh Mục Bài Viết </span><strong></strong></a>
        <ul class="sub">
			...
			<li <?php if ($_GET['typechild'] == 'khachhang') echo ' class="this"' ?> ><a href="index.php?com=news&act=man&typechild=khachhang">Khách hàng</a></li>
    ...
    <li class="gallery_li<?php if ( $_GET["typechild"] == "banner_top" || $_GET["typechild"] == "banner_giua" || $_GET["typechild"] == "banner_phai" || $_GET["typechild"] == "slider" || $_GET["typechild"] == "doitac" || $_GET["typechild"] == "mangxahoi" || $_GET["typechild"] == "mangxahoift") echo ' activemenu' ?>" id="menu6"><a href="#" title="" class="exp"><span>Hình Ảnh</span><strong></strong></a>
		...
		**/?>
			...
			<li <?php if ($_GET['typechild'] == 'hinhanh') echo ' class="this"' ?>><a href="index.php?com=image_url&act=man_photo&typechild=hinhanh">Thư viện ảnh</a></li>
			
			<li <?php if ($_GET['typechild'] == 'quangcao') echo ' class="this"' ?>><a href="index.php?com=image_url&act=man_photo&typechild=quangcao">Banner quảng cáo</a></li>
					
			
			<li <?php if ($_GET['typechild'] == 'mangxahoi') echo ' class="this"' ?>><a href="index.php?com=image_url&act=man_photo&typechild=mangxahoi">Mạng xã hội</a></li>
	...
	<li class="template_li<?php if ( $_GET['com'] == 'info' ) echo ' activemenu' ?>" id="menu_trangtinh"><a href="#" title="" class="exp"><span>Trang tĩnh</span><strong></strong></a>
        <ul class="sub">
			...
			<li <?php if ($_GET['typechild'] == 'product') echo ' class="this"' ?> ><a href="index.php?com=info&act=capnhat&typechild=product">Thực đơn</a></li> 
			
			<li <?php if ($_GET['typechild'] == 'hinhanh') echo ' class="this"' ?> ><a href="index.php?com=info&act=capnhat&typechild=hinhanh">Thư viện ảnh</a></li> 
			...
			<li <?php if ($_GET['typechild'] == 'thoigian') echo ' class="this"' ?> ><a href="index.php?com=info&act=capnhat&typechild=thoigian">Thời gian mở cửa</a></li> 
