...
Tìm kiếm: <input name="keyword" id="keyword" type="text" value="<?=@$_REQUEST['keyword']?>" /> <input type="button" value=" Tìm "  onclick="onSearch(event)"/>
    ...
    <div class="widget" style="overflow: scroll;">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <?php }?>
        <?php if ($check_tt=="on") {?>
        <td class="tb_data_small">Tình trạng</td>
        <?php }?>
    ...
    <tbody>
       ...
       <td align="center" >
        ...
        <td class="title_name_data">
            <a href="index.php?com=product&act=edit&typechild=<?=@$_GET['typechild']?>&id=<?=$items[$i]['id']?>&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id_sub=<?=$items[$i]['id_sub']?>&p=<?=$_REQUEST['p']?>" class="tipS SC_bold"><?=$items[$i]['ten_vi']?></a>
        </td>
	 ...
	 <a href="index.php?com=product&act=man&spmoi=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
       ...
       <?php
		...
		{
		?>
	 <a href="index.php?com=product&act=man&spkm=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
        <?php
		}
		else
		{
		?>
           <a href="index.php?com=product&act=man&spkm=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
       <?php }
        ?>     
       ...
       <?php
		...
		{
		?>
	 <a href="index.php?com=product&act=man&spbc=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
        <?php
		}
		else
		{
		?>
           <a href="index.php?com=product&act=man&spbc=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
       <?php }
        ?>     
       ...
       <?php
		...
		{
		?>
	 <a href="index.php?com=product&act=man&tinhtrang=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
        <?php
		}
		else
		{
		?>
           <a href="index.php?com=product&act=man&tinhtrang=<?=$items[$i]['id']?>&typechild=<?=@$_GET['typechild']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
       <?php }
        ?>     
    ...
    <?php }?>    
        ...
        <td class="actBtns">
            <a href="index.php?com=product&act=edit&typechild=<?=@$_GET['typechild']?>&id=<?=$items[$i]['id']?>&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id_sub=<?=$items[$i]['id_sub']?>&p=<?=$_REQUEST['p']?>" title="" class="smallButton tipS" original-title="Sửa sản phẩm"><img src="./images/icons/dark/pencil.png" alt=""></a>
