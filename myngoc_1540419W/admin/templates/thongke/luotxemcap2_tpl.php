...
<?php
	...
	$d->reset();
	$sql = "select * from #_product_cat where com='product'";
	$d->query($sql);
	$list = $d->result_array();
?>
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
	            <li><a href="index.php?com=thongke&act=luotxem_cap2"><span>Lượt xem danh mục sản phẩm</span></a></li>
...
<div class="widget">
  <div class="titlee" style="padding-bottom:5px;">
     ...
     <div class="timkiem" >
      ...
      <input name="act" value="luotxem_cap2" type="hidden" />
...
<!--       <td class="sortCol" width="120"><div>Mã sản phẩm<span></span></div></td>     -->
        <td class="sortCol"><div>Tên danh mục 2<span></span></div></td>
    ...
    <!--   <td>
        ...
        <td>
               <?=$list[$i]['ten_vi']?>
                ...
                <td align="center">
               <?php 
                $sql = "select sum(luotxem) as luotxemc from #_product where id_cat = ".$list[$i]['id']."   group by id_cat order by id desc ";		
                $d->query($sql);
                $items = $d->fetch_array();
                echo $items['luotxemc'];
               ?>
