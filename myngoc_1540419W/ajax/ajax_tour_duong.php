<?php
	...
	$d->reset();
	$sql_dmsp="select ten_vi as ten,tenkhongdau_$lang as tenkhongdau,id from #_city_sub where hienthi =1 and id_cat=".$id." order by stt asc";
	$d->query($sql_dmsp);
