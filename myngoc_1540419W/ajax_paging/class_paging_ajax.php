...
class paging_ajax
{
    ...
    public function Load()
    {
        ...
        if ($first_btn && $this->cur_page > 1) {
            $msg .= "<li p='1' class='active'>&laquo;</li>";
        } else if ($first_btn) {
            $msg .= "<li p='1' class='$this->class_inactive'>&laquo;</li>";
        }
    
        // HIỂN THỊ NÚT PREVIOUS
        if ($previous_btn && $this->cur_page > 1) {
            $pre = $this->cur_page - 1;
            $msg .= "<li p='$pre' class='active'>&lsaquo;</li>";
        } else if ($previous_btn) {
            $msg .= "<li class='$this->class_inactive'>&lsaquo;</li>";
        }
        ...
        if ($next_btn && $this->cur_page < $no_of_paginations) {
            $nex = $this->cur_page + 1;
            $msg .= "<li p='$nex' class='active'>&rsaquo;</li>";
        } else if ($next_btn) {
            $msg .= "<li class='$this->class_inactive'>&rsaquo;</li>";
        }
        
        // HIỂN THỊ NÚT LAST
        if ($last_btn && $this->cur_page < $no_of_paginations) {
            $msg .= "<li p='$no_of_paginations' class='$this->class_active'> &raquo; </li>";
        } else if ($last_btn) {
            $msg .= "<li p='$no_of_paginations' class='$this->class_inactive'> &raquo; </li>";
        }
