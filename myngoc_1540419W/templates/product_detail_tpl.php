...
<div class="title_right"><h2>Món ăn cùng loại</h2></div>
				...
				<a href="<?= $sanpham_khac[$j]["tenkhongdau_$lang"] ?>">
					...
					<div class="name_product">
							<h3>
								...
								<p >Giá <span><?= number_format($sanpham_khac[$j]["giamgia"], 0, ",", ".") . " đ"; ?> 
									</span>
									<span class="i_giacu"class="i_giacu"><?php if ($sanpham_khac[$j]["gia_vnd"] == "") { ?> <?=_lienhe?> <?php } else { ?> <?= number_format($sanpham_khac[$j]['gia_vnd'], 0, ",", ".") . " đ"; ?> <?php } ?></span>
								</p>
								
							<?php }else{?>
								<p>Giá: <span><?php if ($sanpham_khac[$j]["gia_vnd"] <=0 ) { ?> <?=_lienhe?> <?php } else { ?> <?= number_format($sanpham_khac[$j]['gia_vnd'], 0, ",", ".") . " đ"; ?> <?php } ?></span></p>
							<?php }?>
				    </div>
                </a>
				</div>
