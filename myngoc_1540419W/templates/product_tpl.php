                ...
                <a href="<?= $product[$j]["tenkhongdau_$lang"] ?>">
					...
					<div class="name_product">
							...
							<h3>
								...
								<p >Giá <span><?= number_format($product[$j]["giamgia"], 0, ",", ".") . " đ"; ?> 
									</span>
									<span class="i_giacu"class="i_giacu"><?php if ($product[$j]["gia_vnd"] == "") { ?> <?=_lienhe?> <?php } else { ?> <?= number_format($product[$j]['gia_vnd'], 0, ",", ".") . " đ"; ?> <?php } ?></span>
								</p>
								
							<?php }else{?>
								<p>Giá: <span><?php if ($product[$j]["gia_vnd"] <=0 ) { ?> <?=_lienhe?> <?php } else { ?> <?= number_format($product[$j]['gia_vnd'], 0, ",", ".") . " đ"; ?> <?php } ?></span></p>
							<?php }?>
