...
$baseUrl = $_SESSION['UPLOAD_DIR'];
//$baseDir = '/home/nina64/domains/demo64.ninavietnam.org/public_html/Web2016/Thang3/thuanduc/upload/';
$baseDir = $_SESSION['SCRIPT_FILENAME'].$baseUrl;
$baseUrl = $_SESSION['SERVER_FOLDER'].$baseUrl;
echo($baseDir);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
		'deniedExtensions' => '');
