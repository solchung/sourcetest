...
function updateField(id)
{
    ...
    var value_cn = $('#value_cn' + id).val();
	var name_ge = $('#name_ge' + id).val();
    var value_ge = $('#value_ge' + id).val();
	...
	if (name_vn && value_vn)
	{
		...
		jQuery.ajax({
			...
			data: {'name_vn':name_vn, 'value_vn':value_vn, 'name_en':name_en, 'value_en':value_en, 'name_cn':name_cn, 'value_cn':value_cn, 'name_ge':name_ge, 'value_ge':value_ge, 'id':id},
			success:function (data) {
				$('#ajaxloader'+id).css('display', 'none');
			}
		});
...
function fillValue(name)
{
	...
	jQuery.ajax({
		...
		success:function (data) {
			...
			$('#cname_cn').val(myObject['name_cn']);
			$('#cvalue_cn').val(myObject['value_cn']);
			$('#cname_ge').val(myObject['name_ge']);
			$('#cvalue_ge').val(myObject['value_ge']);
