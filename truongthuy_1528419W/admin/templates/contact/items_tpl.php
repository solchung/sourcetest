  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
      ...
      <a href="index.php?com=contact&act=edit&id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Sửa"><img src="./images/icons/dark/pencil.png" alt=""></a>
            <a href="index.php?com=contact&act=delete&id=<?=$items[$i]['id']?>" onclick="CheckDelete('index.php?com=contact&act=delete&id=<?=$items[$i]['id']?>'); return false;" title="" class="hidden_log smallButton tipS" original-title="Xóa"><img src="./images/icons/dark/close.png" alt=""></a>        </td>
      </tr>
         <?php } ?>
                </tbody>
