...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=newsletter&act=man"><span>Email đăng ký </span></a></li>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
       ...
       <td style="width:15%;">Ngày đăng ký</td>       
   ...
   <td class="title_name_data">
         ...
         <a href="index.php?com=newsletter&act=edit&id=<?=$items[$i]['id']?>" class="tipS SC_bold"><?=$items[$i]['email']?></a>
          ...
          <td>
         <a href="index.php?com=newsletter&act=edit&id=<?=$items[$i]['id']?>" class="tipS SC_bold"><?=$items[$i]['sex']?></a>
        </td>
		  <td>
         <a href="index.php?com=newsletter&act=edit&id=<?=$items[$i]['id']?>" class="tipS SC_bold"> <?=date('d/mY',$items[$i]['ngaytao'])?></a>
        </td>
