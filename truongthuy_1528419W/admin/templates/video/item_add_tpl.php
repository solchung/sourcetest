    ...
    <?php }  }?>
      ...
      <?php if ($link_active==on) {?>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <input type="text" id="toado" name="link" value="<?=@$item['link']?>"  title="Nhập link" class="tipS link_active" />  <strong>Ex:https://www.youtube.com/watch?v=<b style="color:red">IpWskE_J_Ps</b></strong>
            </div>
            <div class="clear"></div>
        </div>    
