                ...
                <a href="<?= $row["tenkhongdau_$lang"] ?>">
					...
					<div class="name_product">
							...
							<h3>
								...
								<p >Giá <span><?= number_format($row["giamgia"], 0, ",", ".") . " VNĐ"; ?> 
									</span>
									<span class="i_giacu"class="i_giacu"><?php if ($row["gia_vnd"] == "") { ?> <?=_lienhe?> <?php } else { ?> <?= number_format($row['gia_vnd'], 0, ",", ".") . " VNĐ"; ?> <?php } ?></span>
								</p>
								
							<?php }else{?>
								<p>Giá: <span><?php if ($row["gia_vnd"] <=0 ) { ?> <?=_lienhe?> <?php } else { ?> <?= number_format($row['gia_vnd'], 0, ",", ".") . " VNĐ"; ?> <?php } ?></span></p>
							<?php }?>
				    </div>
                </a>
