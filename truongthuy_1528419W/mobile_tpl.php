...
<body >
    ...
    <div class="container_s">
        <div class="container-fluid pd0">
			...
			<?php if($source=="index"){?>
				...
				<div class="row pd0 mg0 ">
					<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
					<?php include _template . "layout/about_index.php"; ?>
					</div>
				</div>	
			<?php }?>	
			 ...
			 <div class="row pd0 mg0 ">				
					<div class="row pd0 mg0 clearfix">						
						<?php if($template=='product_detail') {?>					
							<div class="container ">	
								<div class="cot_left_s col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
									<?php include _template . "layout/left.php"; ?>
								</div>	
								<div class="cot_mid_s col-lg-9 col-md-9 col-sm-12 col-xs-12 pd0">
									<?php include _template . $template . "_tpl.php"; ?>
								</div>	
							</div>	
            ...
            jQuery(document).ready(function () {
                ...
                $(window).scroll(function () {
                    if ($(window).scrollTop() > 50) {
                        $('.k_menu').addClass("menufix");
						$('.phone-info').addClass("fix_phone");
					
                    } else {
                        $('.k_menu').removeClass("menufix");
	...
	<script src="js/fotorama-4.6.4/fotorama.js"></script> <!-- 16 KB -->
