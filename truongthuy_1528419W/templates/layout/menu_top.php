...
<div class="menu">
    ...
    <div id="smoothmenu1"  class="ddsmoothmenu" >
        <ul class="clearfix">
			...
			<li><span class="space"></span></li>
			<li class=" font_custom <?php if ($_GET['com'] == 'san-pham') echo 'active'; ?>"><a href="san-pham" class="font_custom <?php if ($_GET['com'] == 'san-pham') echo 'active'; ?>">Sản phẩm</a>   
			<ul>
			...
			<li class="font_custom <?php if ($_GET['com'] == 'hat-dieu-nguyen-lieu') echo 'active'; ?>"><a href="hat-dieu-nguyen-lieu" class="font_custom <?php if ($_GET['com'] == 'hat-dieu-nguyen-lieu') echo 'active'; ?>">Hạt điều nguyên liệu</a>   
			</li>
			<li><span class="space"></span></li> 
